...
const Left = () => {
  return (
    <div className="bg-[var(--primary-color)] flex flex-col justify-start items-center py-6 px-4 text-white">
      <h2 className="font-bold font-header text-3xl">Welcome to AI Hub!</h2>
